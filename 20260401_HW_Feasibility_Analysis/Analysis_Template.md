...
| 2026-04-01 | 03 UB 256K + Sequential + SM overlap | UB 256KiB, sequential core, SM overlap, weight-first, halo 계산 | 7/8 FAIL, **v10n Adaptive Full = PASS** | `20260401_03_HW_Feasibility_Analysis/` |
| 2026-04-01 | 04 Safe Boundary | Q+UB 동시 만족 weight/input 한계, T 결정 이차부등식 공식 | v10n 전체 PASS (margin 88KB), v10s 9 layer FAIL | `20260401_04_Safe_Boundary_Analysis/` |
| | | | | |
