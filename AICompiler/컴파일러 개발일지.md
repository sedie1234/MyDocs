...
## 1. 개요
 ...
 - 런타임은 Binary와 json을 읽고, model을 init한다.

![iree-air-aie-architecture 2](iree-air-aie-architecture%202.png)



- 개발 범주
![KETI-Compiler-develop-area](KETI-Compiler-develop-area.png)
...
![AI-Compiler-code_outline](AI-Compiler-code_outline.png)
- [[컴파일러 적용과 mlir의 변화]]
## 2. 이론 및 개념
